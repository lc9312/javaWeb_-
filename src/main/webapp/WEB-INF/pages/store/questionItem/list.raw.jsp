...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/questionItem?operation=${operation}&id=${questionItem.id}" method="post">
                 <%-- 设置隐藏域,上传questionId --%>
                <input type="text" name="questionId" value="${questionId}">
                <input type="text" name="questionId" value="${operation}">
                <input type="text" name="questionId" value="${questionItem.id}">
