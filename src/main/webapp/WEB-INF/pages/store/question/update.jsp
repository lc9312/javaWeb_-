        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <form id="editForm" action="${ctx}/store/question?operation=edit" method="post" type="file"
                    enctype="multipart/form-data">

                        <input type="hidden" name="id" value="${question.id}">
                        <input type="hidden" name="id" value="${question.picture}">
                        <%--<input type="text" name="id" value="${question.picture.length()}">--%>
                        ...
                        <div class="tab-pane active" id="tab-form">
                            <div class="row data-type">
                                ...
                                <div class="col-md-2 title rowHeight2x">题干图片</div>
                                <div class="col-md-10 data rowHeight2x">
                                    <input name="picture" type="file" class="form-control" placeholder="题干图片" value="${question.picture}"/><br>
                                </div>

                                <c:if test="${question.picture.length() > 0}">
                                    <div class="col-md-2 title">题干图片</div>
                                    <div class="col-md-10 data " style="height: 600px">
                                        <img src="${ctx}/file/${question.picture}" width="100%"/>
                                    </div>
                                </c:if>
