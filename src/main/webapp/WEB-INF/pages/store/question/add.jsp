            ...
            <div class="box-body">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <form id="editForm" type="file" action="${ctx}/store/question?operation=save" method="post" enctype="multipart/form-data">
                            <div class="tab-pane active" id="tab-form">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data rowHeight2x">
                                        <input name="picture" type="file" class="form-control" placeholder="题干图片"/>
                                    </div>
